...
We present a novel machine learning algorithm, {Student Profficiency Inferrer from Game data} (\algname), that allows modeling  game playing behavior in educational games.
...
In this paper, we propose \textit{Student PRofficiency INferrer from Game data} (SPRING), a novel machine learning algorithm that models game playing behavior.
