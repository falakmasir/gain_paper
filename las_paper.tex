...
Our results suggest that \algname is accurate to predict Math assessments ($R^2$ =0.55 , Spearman $\rho$=0.51).
\end{abstract}
...
We hypothesized that students in difference performance groups play the game differently. Our sequence modeling phase should be able to capture this difference by observing the playing pattern of each group.
...
\begin{table}[tbh]
	...
	\begin{tabular}{@{}lllll@{}}
		...
		Success / Failure                                                      & 0.01                                                     & 0.63                                                 & 3.22                                                          & 4.14 \\
				\algname ($K=2, H=1$)                                                   0.17                                                     & 0.15                                                 &   3.60                                                        & 3.10 \\ 
		\algname ($K=2, H=2$)                                                      & 0.55                                                     & 0.82                                                 & 2.84                                                          & 3.35 \\ \bottomrule
	\end{tabular}
	\caption{The results of predicting post-test scores using three different feature sets \hl{Bold the best model.  Are differences statistical significant? Consider adding confidence intervals?} }~\label{tab:results}	
\end{table}
