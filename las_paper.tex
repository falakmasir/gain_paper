...
\begin{table}[tbh]
	...
	\begin{tabular}{@{}lllll@{}}
		...
		Success / Failure                                                      & 0.02                                                     & 0.16                                                 & 3.21                                                          & 4.08 \\
				...
				3.60 & 3.10 \\ 
		\textbf{\algname ($K=2, H=2$)}                                                      & \textbf{0.55}                                                     & \textbf{0.51}                                                 & \textbf{2.84}                                                          & \textbf{3.35} \\ \bottomrule
	\end{tabular}
...
We investigated this problem in more depth and we believe that the reason we could not achieve significant improvement was mainly because we tested the algorithm on a small dataset.
Our heldout set contains only 15 students and a few of them achieved poor performance results in the post-test while successfully finishing most of the game levels. We believe that using a larger data set will lower the negative effect of such students in the future.
